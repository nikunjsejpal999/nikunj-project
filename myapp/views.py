...
def change_password(request):
	if request.method=='POST':
		...
		if user.password==request.POST['old_password']:
			if request.POST['new_password']==request.POST['cnew_cpassword']:
				user.password=request.POST['cnew_cpassword']
				user.save()
				del request.session['email']
				del request.session['fname']
...
def seller_edit_product(request,pk):
	...
	if request.method=='POST':
		...
		return render(request,'seller_edit_detail.html',{'product':product,'msg':msg})

	else:
		return render(request,'seller_edit_detail.html',{'product':product})
...
def seller_delete_product(request,pk):
	...
	return render(request,'seller_view_product.html',{'products':products,'msg':msg})
